...
<html>
  <head>
    <meta charset="utf-8">
    <title>Instalación Librera</title>
  ...
  <body style="background-color:blue; ">
	...
	<div style="width:1000px;margin: 0 auto;margin-top:45px;">
		<div>
			<h1 style="margin-left:20px;margin-bottom:25px;color:white;">Instalador Aplicación Web</h1>
		</div>
		...
		<div class="form-group col-lg-5">
			<div class="form-group">
				<input type="text" name="fhost" class="form-control input-lg" placeholder="Host de la BD " required>
			</div>
		</div>
		
		<div class="form-group col-lg-5">
		  <div class="form-group">
			  <input type="text" name="fbd" class="form-control input-lg" placeholder="Nombre de la BD" required>
			</div>
		</div>
