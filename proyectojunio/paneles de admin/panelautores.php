...
<<div class="row">
    ...
    <td><b>apellidos</td>
      ...
      while($obj = $result->fetch_object()) {
          ...
          echo " <td><a href='modificarautor.php?id=".$obj->codigo."&n=".$obj->nombre."&a=".$obj->apellidos."'><img src='editar.png' width='70px' ></a></td>";
          echo " <td><a href='insertarautor.php'><img src='masd.png' width='70px' ></a></td>";
          echo " <td><a href='elimana.php?id=".$obj->codigo."'><img src='eliminar.jpeg' width='70px' ></a></td>";
