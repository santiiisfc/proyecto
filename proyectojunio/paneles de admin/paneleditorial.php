...
<div class="row">
    ...
    <td><b>nombre</td>
      ...
      while($obj = $result->fetch_object()) {
          ...
          echo " <td><a href='editareditorial.php?id=".$obj->codigoedi."&n=".$obj->nombre."'><img src='editar.png' width='70px' ></td>";
          echo " <td><a href='insertareditorial.php'><img src='masd.png' width='70px' ></td>";
          echo " <td><a href='eliminaedi.php?id=".$obj->codigoedi."'><img src='eliminar.jpeg' width='70px' ></td>";
