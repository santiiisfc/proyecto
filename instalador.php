    ...
    <div class='form-group col-lg-5'>
            <form action="" method="post">
                ...
                <input type="text" name="usu" class="form-control input-lg " placeholder="Usuario" required>		</div>
    				...
    				<div class="form-group col-lg-5">
    					<div class="form-group">
                    <input type="db_pass" name="pass" class="form-control input-lg" placeholder="Contraseña">
    					</div>
    				</div>
            <div class="form-group col-lg-5">
    					<div class="form-group">
                  <input type="text" name="dhost" class="form-control input-lg" placeholder="Host de la BD" required>
                </div>
    				</div>

            <div class="form-group col-lg-5">
              <div class="form-group">
                  <input type="text" name="db" class="form-control input-lg" placeholder="Nombre de la BD" required>
                </div>
            </div>
            <div class="form-group col-lg-5">
              <div class="form-group">
    ...
    <?php
          if(isset($_POST["usu"])){
              ...
              $connection = new mysqli($db_host, $db_user, $db_pass, $db_name);
                 //TESTING IF THE CONNECTION WAS RIGH
              if ($connection->connect_errno) {
                   printf("Connection failed: %s\n", $connection->connect_error);
                   exit();
              }else{
                include("./database.php");
                $file = fopen("./instalador/db_var.php", "a");
                fwrite($file, "<?php"."\n");
                fwrite($file, "$"."db_user="."'".$db_user."';"."\n");
                fwrite($file, "$"."db_pass="."'".$db_pass."';"."\n");
                fwrite($file, "$"."db_base="."'".$db_name."';"."\n");
