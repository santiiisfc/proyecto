...
<html>
  ...
  <body style="background-color:blue">
    <div style="width:1000px;margin: 0 auto;margin-top:40px;">
      <div>
          <h1 style="margin-left:20px;margin-bottom:20px;color:red";>Instalador Aplicacion Web</h1>
    <div class='form-group col-lg-5'>
            <form action="" method="post">

    					<div class="form-group">
                <input type="text" name="fusu" class="form-control input-lg " placeholder="Usuario" required>		</div>
    				</div>
    				<div class="form-group col-lg-5">
    					<div class="form-group">
                    <input type="password" name="fpass" class="form-control input-lg" placeholder="Contraseña">
    					</div>
    				</div>
            <div class="form-group col-lg-5">
    					<div class="form-group">
