      ...
      <?php
               ...
               while($obj = $result->fetch_object()) {
                 ...
                 echo "<td><a href='verPedidoAdmin.php?idpedido=".$obj->Pedido."'>Ver</a></td>";
				   echo " <td><a href='modificarpedido.php?id=".$obj->Pedido."'><img src='editar.png' width='45px' ></td>";
			echo " <td><a href='eliminarpedido.php?id=".$obj->Pedido."'><img src='eliminar.jpeg' width='45px' ></td>";
			  echo "</tr>";
               }
          }
